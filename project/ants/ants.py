...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        distance = 0
        while cur_place and not cur_place.is_hive and distance <= self.max_range:
            if cur_place.bees and distance >= self.min_range:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        "*** YOUR CODE HERE ***"
        cur_place = self.place
        damage = amount + (self.damage if amount >= self.health else 0)
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8
        "*** YOUR CODE HERE ***"
        # return (not self.ant_contained) and (type(self.ant_contained) == ContainerAnt)
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def construct(cls, gamestate):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        # if not gamestate.has_quen:
        #     gamestate.has_quen = True
