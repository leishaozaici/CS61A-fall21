...
def pingpong(n):
    ...
    #     return n
    # else:
    #     if n % 8 == 0 or num_eights(n) >= 1:
    #         return pingpong(n-1) - 1 if pingpong(n-2) > pingpong(n - 1) else pingpong(n-1) + 1
    #     else:
...
def missing_digits(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    len_set = len(set(str(n)))
    return int(str(n)[-1]) - int(str(n)[0]) - len_set + 1
...
def count_coins(change):
    ...
    """
    "*** YOUR CODE HERE ***"
    # if change == 1 or change == 5 or change == 10 or change == 25:
    #     return 1
    # else:
    #     for i in
